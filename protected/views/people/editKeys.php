...
<?php $form = $this->beginWidget('CActiveForm', array(
	...
	<p class="alert alert-info">Please be aware that SSH Key changes will be synced to KDE infrastructure automatically, and should be active within 1 minute.</p>
